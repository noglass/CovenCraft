...
execute store result score #x coven.candle run data get storage coven:ritual IdentityPosFound[0] 10
execute store result score #y coven.candle run data get storage coven:ritual IdentityPosFound[1] 10
execute store result score #z coven.candle run data get storage coven:ritual IdentityPosFound[2] 10
